            ...
            if (!entity.aW()) {
                ...
                if (!entity.dead) {
                    ...
                    if (distanceSquared <= 64.0D && distanceSquared != 0.0D) {
                        ...
                        double finalD = d8 * 1.1;  // Store normalized X direction for later use
                        double finalD1 = d9 * 1.1;  // Store normalized Y direction for later use
                        double finalD11 = d10 * 1.1;  // Store normalized Z direction for later use
